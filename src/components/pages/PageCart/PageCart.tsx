...
export default function PageCart() {
  ...
  const cartItemsWithProducts: CartItemWithProduct[] = React.useMemo(() => {
  ...
  return (
    <PaperLayout>
      ...
      {!isCartEmpty && activeStep === CartStep.ReviewCart && (
        <ReviewCart items={cartItemsWithProducts} />
      )}
      ...
      {activeStep === CartStep.ReviewOrder && (
        <ReviewOrder address={delivery} items={cartItemsWithProducts} />
      )}
